        ...
        <footer className="border-t border-base-300/70 bg-base-100">
            <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-6 sm:flex-row sm:items-center sm:justify-between lg:px-10">
                ...
                <div className="flex items-center gap-2">
                    <a href={VOICEY_HELP_DISCORD_URL} target="_blank" rel="noreferrer" className="btn btn-ghost btn-circle btn-sm" title="Discord" aria-label="Discord">
                    ...
                    <a href={ROICEY_GITHUB_URL} target="_blank" rel="noreferrer" className="btn btn-ghost btn-circle btn-sm" title="GitHub" aria-label="GitHub">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-current">
                    ...
                    <Link to={localizedPath('/legal')} className="link link-hover ml-2 text-sm font-medium text-base-content/80">
                        {t('footer.legal')}
                    </Link>
                    <Link to={localizedPath('/privacy-policy')} className="link link-hover text-sm font-medium text-base-content/80">
                        {t('footer.privacy')}
                    </Link>
